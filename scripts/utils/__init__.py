...
_add_runner(Runner('java',
                   s3_clients=['crt-java', 'sdk-java-client-crt', 'sdk-java-tm-crt', 'sdk-java-client-classic', 'sdk-java-tm-classic']))
...
_add_runner(Runner('dotnet', s3_clients=['sdk-dotnet-client', 'sdk-dotnet-tm']))
